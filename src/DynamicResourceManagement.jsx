...
export default function DynamicResourceManagement() {
  return (
    <section className="w-full bg-black pb-20">
      {/* Purple header bar */}
      <div className="w-full bg-gradient-to-r from-[#3b256b] to-[#2d174c] py-8 px-4 md:px-12 flex flex-col md:flex-row md:items-center mx-auto md:justify-between">
        <div>
        ...
        <div className="flex gap-3  mt-6 md:mt-0">
          <button className="bg-[#a78bfa] hover:bg-[#7c3aed] text-white font-semibold px-6 py-2 rounded-lg text-base shadow transition">Set Up a Time</button>
      ...
      {/* Main content */}
      <div className="w-full max-w-7xl mx-auto px-4 flex flex-col md:flex-row gap-12 mt-16">
        {/* Left column */}
